...
import HeaderBar from '../components/Layout/HeaderBar'; // Header component (top bar with user menu)
import FooterBar from '../components/Layout/FooterBar'; // Footer component for page bottom
